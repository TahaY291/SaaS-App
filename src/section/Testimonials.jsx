import testimonials from "../contants/testimonials.js";
import TestimonialItem from "../components/TestimonialItem.jsx";

function Testimonials() {
  const halfLength = Math.floor(testimonials.length / 2);
  return (
    <section className="relative z-2 py-24 md:py28 lg:py-40">
      <div className="container block lg:flex">
        <div className="testimonials_heads-res relative z-2 mr20 flex-300">
